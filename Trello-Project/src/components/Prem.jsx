...
const Prem= () => {
  return (
    <div className="w-[270px] h-[540px] ml-0 p-5 pt-2  bg-white border-[2px] border-blue-400 shadow-md font-[\'Charlie_Display\']] flex flex-col justify-between ">
      ...
      <a className="text-blue-600 text-lg font-semibold underline" href="">Learn more about Premium</a>
      </div>
      </div>
  )}
  export default Prem