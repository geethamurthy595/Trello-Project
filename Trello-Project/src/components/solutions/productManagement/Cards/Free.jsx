...
const Free = () => {
  return (
    <div className="w-[270px] h-[600px]  ml-16 p-5 pt-2  bg-white border border-[#ccc]   shadow-md font-[\'Charlie_Display\']] flex flex-col justify-between ">
      ...
      <button className="border-1 border-blue-500 w-35 p-3 rounded-[5px]">Get started</button><br />
    </div>
    </div>
  );
};
