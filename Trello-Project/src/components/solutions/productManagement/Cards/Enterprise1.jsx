...
import Rightimg from "../../../../assets/coinbase.png";
import Ilogo from "../../../../assets/j.svg"
...
const Enterprise1  = () => {
  ...
  return (
    <div className="w-[277px] h-[600px] ml-0 p-5 pt-2 bg-white border  border-[#ccc] border-gray-300  shadow-md font-[\'Charlie_Display\'] flex flex-col justify-between">
