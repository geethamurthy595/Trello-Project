...
const Standard = () => {
  return (
    <div className="w-[270px] h-[650px]  p-5 pt-2  bg-white border border-gray-400 shadow-md font-[\'Charlie_Display\']] flex flex-col justify-between ">
      ...
      <button className="border-1 border-blue-500 w-35 p-3 rounded-[5px] hover:cursor-pointer">Sign up now</button><br />
      <a href="https://trello.com/standard " className="hover:cursor-pointer underline text-blue-900 ">Learn more about Standard</a>
    </div>
    </div>
  );
};
