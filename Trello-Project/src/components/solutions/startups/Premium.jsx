...
const Premium = () => {
  return (
    <div className="w-[270px] h-[650px] ml-0 p-5 pt-2  bg-white border-[2px] border-blue-400 shadow-md font-[\'Charlie_Display\']] flex flex-col justify-between ">
      ...
      <button className="border-1 border-blue-600 w-35 p-3 rounded-[5px] bg-[#E6FCFF] hover:border-blue-400 hover:cursor-pointer">Try for free</button><br />
      <a href="https://trello.com/premium " className="hover:cursor-pointer underline text-blue-900 ">Learn more about Premium</a>
    </div>
    </div>
  );
};
