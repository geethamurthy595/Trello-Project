...
const Enterprise = () => {
  ...
  return (
    <div className="w-[277px] h-[650px] ml-0 p-5 pt-2 bg-white border border-gray-400  shadow-md font-[\'Charlie_Display\'] flex flex-col justify-between">
      <div className="pt-1 flex flex-col h-full">
        ...
        <button className="border-1 border-blue-500 w-35 p-3 rounded-[5px] hover:cursor-pointer">Contact sales </button><br />
          <a href="https://trello.com/enterprise" className="underline text-blue-900 hover:cursor-pointer">Learn more about Enterprise</a>
      </div>
    </div>
  );
};
