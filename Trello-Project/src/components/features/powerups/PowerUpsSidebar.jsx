...
const PowerUpsSidebar = () => {
  return (
    <nav className=" w-[550px]  py-4 pr-5 pl-[150px] ">
      ...
      <Link to='category/board-utilities'>
      <div className="flex items-center gap-1 py-1 pl-8 hover:bg-[#2B2C2F] rounded mb-2 cursor-pointer">
        <p className="w-full font-semibold  m-0 p-0">Board utilities</p>
      </div>
      </Link>
     
      <Link to='category/communication-collaboration'>
      <div className="flex items-center gap-1 py-1 pl-8 hover:bg-[#2B2C2F] rounded mb-2 cursor-pointer">
        <p className="w-full font-semibold  m-0 p-0">
          Communication & <br />
          collaboration
        </p>
      </div>
      ...
      <Link to="hr-operations" className="flex items-center gap-1 py-1 pl-8 hover:bg-[#2B2C2F] rounded mb-2 cursor-pointer">
      ...
      <Link to="category/marketing-social-media">
        <div className="flex items-center gap-1 py-1 pl-8 hover:bg-[#2B2C2F] rounded mb-2 cursor-pointer">
          <p className="w-full font-semibold  m-0 p-0">
      ...
      <Link to="category/product-design" className="flex items-center gap-1 py-1 pl-8 hover:bg-[#2B2C2F] rounded mb-2 cursor-pointer">
        <p className="w-full font-semibold  m-0 p-0">Product & design</p>
      </Link>
      <Link to="category/salesandsupport">
        <div className="flex items-center gap-1 py-1 pl-8 hover:bg-[#2B2C2F] rounded mb-2 cursor-pointer">
        <p className=" w-full font-semibold  m-0 p-0">Sales & support</p>
      </div>
      </Link>
      <p className="text-xs py-1 pl-8">
        Looking for browser extensions, add-ons, and more?
        <span className="text-[#669DF1] underline cursor-pointer">
          Check out our <br /> integrations
        </span>
      </p>
      <p className="text-xs py-1 pl-8">
        You can build Power-Ups for millions of people who use Trello, or build
        a private custom Power-Up for your team or company.{" "}
        <span className="text-[#669DF1] underline cursor-pointer">
          Learn how here.
        </span>
      </p>
...
export default PowerUpsSidebar;
