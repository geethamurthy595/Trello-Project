      ...
      <div className="flex gap-19">
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-black-700">Made by Blue Anvil Software Pty Ltd</p>
    ...
    <hr className="border-gray-300 w-70 ml-[-25px]"></hr>
        ...
        <div>
          ...
          <p className="text-black-600 mt-5 leading-relaxed">
            This Power-Up lets you easily capture sale amounts, estimate hours,
            or any other metric you can think of, and automatically updates the
            total at the top of each list.
          </p>

          <p className="text-black-600 mt-3">
            <span className="italic">SumUp</span> is a <b>FREE</b> Power-Up that
            allows one value to be summed. Need more values? Upgrade to
            <span className="italic"> SumUp Pro</span> for a small annual fee to
            add up to six sum values.
          </p>

          <div className="mt-8  rounded-xl overflow-hidden ">
            <img src={sumupdemo} alt="sumup demo" className="w-150 rounded-lg "/>
         <img src={iblsumup} alt="icon" className="absolute top-2 right-3 w-4 h-4 bg-white"/>
      </div>
