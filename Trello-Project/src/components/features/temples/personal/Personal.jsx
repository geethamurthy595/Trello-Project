...
import personalsvg from "../../../../assets/personalsvg.svg";
    ...
    <>
      <div className="w-200">
        ...
        <div className="w-full h-28 flex items-center gap-4">
          <div className="">
            <img src={personallogo} alt="img" className="w-15 rounded-md" />
          </div>
        ...
        <div className="w-full h-full">
          ...
          <div className="w-full h-fit flex flex-col md:flex-row items-center justify-between gap-8 rounded-xl mt-10">
            ...
            <div className="md:w-3/4 w-full flex flex-col gap-4">
              <p className="text-lg text-gray-700 leading-relaxed">
                Use Trello to organize, track, and plan anything life throws
                your way. See personal projects to completion and hold yourself
                accountable for all kinds of goals you might set. From moving to
                planning a vacation to getting ready for your wedding, and
                everything in between, there's a template for that.
              </p>
            </div>
